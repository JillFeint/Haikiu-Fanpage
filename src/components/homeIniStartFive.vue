...
<div class="main">
  <div class="up">
    <button class="card1">
      <a href="https://www.instagram.com/haikyuuu.official/embed/">
    ...
    <button class="card2">
      <a href="https://www.facebook.com/haikyuulyabout?locale=es_LA">
  ...
  <div class="down">
    <button class="card3">
      <a href="https://api.whatsapp.com/send/?phone=+573125264707">
    ...
    <button class="card4">
      <a href="https://es.wikipedia.org/wiki/Haiky%C5%AB!!">
...
.main {
  ...
  position: absolute;
  right: 10px;
  z-index: 999; /* Ajusta el valor según sea necesario para asegurar que esté encima de otros elementos */
}
.up {
  display: flex;
  flex-direction: row;
...
.card1 {
  width: 70px; /* Ajusta el tamaño según tus preferencias */
  height: 70px; /* Ajusta el tamaño según tus preferencias */
  outline: none;
  border: none;
  background: white;
